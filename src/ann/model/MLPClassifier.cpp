...
//////////////////////////////////////////////////////////////////////////////////////////
  ...
  int tol_data = pLoader->get_sample_count();  
  int num_classes = this->get_num_classes();     

  xt::xarray<double> results = xt::zeros<double>({tol_data, num_classes});
  int row_index = 0;
  for (auto batch : *pLoader) 
  {
    ...
    xt::view(results, xt::range(row_index, row_index + batch_size), xt::all()) = Y;
